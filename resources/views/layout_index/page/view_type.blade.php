											...
											<div class="tg-postbook">
												<figure class="tg-featureimg" style="height: 250px">
													<div class="tg-bookimg">
														...
														<div class="tg-backcover"><img src="{{ asset('images/product/' . $books->image) }}" alt="image" width="150px" height="150px" /></div>
													</div>
												...
												<div class="tg-postbookcontent">
													...
													<div class="tg-booktitle">
														<h3><a href="{{ route('detail', $books->id) }}">{{ $books->name }}</a></h3>
													</div>
							...
							<div class="tg-widget tg-widgetsearch">
								<form class="tg-formtheme tg-formsearch">
									<div class="form-group">
										...
										<input type="search" name="search" class="form-group" placeholder="{{ __('Enter keywords') }}" id="myInput" onkeyup="myFunction()">
									</div>
								</form>
							</div>
