									...
									<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
										<div class="tg-postbook">
											...
											<div class="tg-postbookcontent">
												...
												<a class="tg-btn tg-active tg-btn-lg" href="javascript:void(0);" onclick="AddCart('{{ $product_detail->id }}')">Giỏ hàng</a>
												...
												<div class="tg-share">
													...
													<ul class="tg-socialicons">
														<li class="tg-facebook"> @if($store && $store->stored_product == 0)
															&emsp;<h6 class="badge badge-danger" style="font-size: 17px;background-color: #d61f16; ">Hết hàng&ensp;</h6>
															@else
															&emsp;<h6 class="badge badge-success" style="font-size: 17px;background-color: #17c55d;">Còn hàng&ensp;</h6>
															@endif</li>
